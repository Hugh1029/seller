<template>
  <div class="ratings" ref="ratings">
    <div class="rating-content">
      ...
      <split></split>
      <rating :selectType="selectType" :onlyContent="onlyContent" :desc="desc"
              :ratings="ratings" @changSelectType="changeType" @toggleContent="toggle"></rating>
